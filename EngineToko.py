    ...
    while True:
        ...
        if jumlahData == jumlahDataBackup:
            ...
            for i in range(0, jumlahData):
                if data[i][1] != dataBackup[i][1]:
                    print(
                        "Update data pada Database Toko pada data jenis_kain, data sebelumnya adalah %s diupdate menjadi %s pada id %s" % (
                            dataBackup[i][1], data[i][1], data[i][0]))

                    # proses update pada tb transaksi backup pada Database Toko
                    curToko.execute("UPDATE tb_transaksi_backup SET jenis_kain='%s' WHERE id=%s;" % (
                        data[i][1], dataBackup[i][0]))
                    dbToko.commit()

                    UpdateJson(data[i][0], data[i][1], data[i][2], data[i][3], data[i][4],data[i][5], data[i][6])


                # cek pembaruan atas nama
                elif data[i][2] != dataBackup[i][2]:
                    print(
                        "Update data pada Database Toko pada data kwalitas_kain, data sebelumnya adalah %s diupdate menjadi %s pada id %s" % (
                ...
                # cek pembaruan jumlah
                    ...
                    print(
                        "Update data pada Database Toko pada data tekstur_kain, data sebelumnya adalah %s diupdate menjadi %s pada id %s" % (
                ...
                # cek pembaruan kode unik
                    ...
                    print(
                        "Update data pada Database Toko pada data warna_kain, data sebelumnya adalah %s diupdate menjadi %s pada id %s" % (
                ...
                # cek pembaruan status
                    ...
                    print(
                        "Update data pada Database Toko pada data panjang_kain, data sebelumnya adalah %s diupdate menjadi %s pada id %s" % (
                ...
                # cek pembaruan tanggal
                    ...
                    print(
                        "Update data pada Database Toko pada data harga, data sebelumnya adalah %s diupdate menjadi %s pada id %s" % (
        ...
        # proses pengecekan jika terjadi insert data baru di tabel
            ...
            for i in range(insertMin, beforeMaxInsert):
                # pemberitahuan
                print(
                    "Insert data pada Database Toko dengan index %s ,data yang di-insert adalah jenis_kain =%s, kwalitas_kain = %s, tekstur_kain = %s, warna_kain = %s, panjang_kain = %s , harga = %s" % (
                ...
                InsertJson(data[i][0], data[i][1], data[i][2], data[i][3], data[i][4], data[i][5],
                                data[i][6])
            ...
            for i in range(0, jumlahDataBackup):
                ...
                curToko.execute("SELECT * FROM tb_transaksi WHERE tb_transaksi.`id`=%s;" % dataBackup[i][0])

                if curToko.rowcount == 0:
                    print(
                    ...
                    DeleteJson(dataBackup[i][0], dataBackup[i][1], dataBackup[i][2], dataBackup[i][3],
                                         dataBackup[i][4],
                    ...
                    # pemberitahuan
                    print(
                        "Delete data pada Database Toko dengan index %s,data yang di-delete adalah jenis_kain =%s, kwalitas_kain = %s, tekstur_kain = %s, kode unik = %s, panjang_kain = %s , harga = %s" % (
                            dataBackup[i][0], dataBackup[i][1], dataBackup[i][2], dataBackup[i][3],
